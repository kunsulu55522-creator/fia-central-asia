...
import { programs, team } from "@/data/site";

export default function HomePage() {
  return (
    <>
      <Hero
        eyebrow="Fowler International Academy of Professional Coaching"
        title="Освойте коучинг, который превращает знания в действия"
        text="Мы обучаем профессиональному коучингу по методологии FIA и помогаем студентам из Казахстана, Центральной Азии и других русскоязычных стран применять коучинговые навыки в бизнесе, консультировании, работе с командами и новой профессии."
        image="/images/fia-hero-training.png"
        badges={["Генеральное представительство FIA в Казахстане и Центральной Азии", "80% практики / 20% теории", "Методология Берри Фаулера"]}
      />
      ...
      <section className="container-px bg-porcelain py-20">
        <SectionHeader eyebrow="Для кого" title="Мы обучаем коучингу для бизнеса, практики и новой профессии" text="Каждая аудитория приходит с разной задачей. Мы помогаем увидеть, как коучинговый подход может работать именно в вашем профессиональном контексте." />
      ...
      <section className="container-px section-divider bg-mist py-20">
        <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
          <SectionHeader eyebrow="Программы" title="Выберите направление FIA под вашу цель" text="Мы поможем подобрать программу: для старта в профессии, применения коучинга в управлении или развития специализации." />
      ...
      <section className="container-px bg-porcelain py-20">
        <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          ...
          <div>
            <SectionHeader eyebrow="Почему FIA" title="Мы передаём методологию, созданную практиком" text="Наша академия опирается на опыт Берри Фаулера — американского предпринимателя и коуча с более чем 45-летней практикой. Мы сохраняем фокус на применении: вопросы, структура сессии, ответственность и действие." />
      ...
      <section className="container-px bg-mist py-20">
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <SectionHeader eyebrow="ICF" title="Сертификация и международные стандарты" text="Наш курс аккредитован Международной Федерацией Коучинга (ICF), что подтверждает его соответствие мировым стандартам качества." />
          <div className="rounded-lg border border-graphite/10 bg-white p-6">
            <p className="text-lg leading-8 text-slate">
              Мы заранее объясняем студентам формат обучения, сертификат FIA и дальнейшие шаги. Если у вас есть вопросы о требованиях, статусе курса или применимости сертификата, представитель академии поможет уточнить детали до подачи заявки.
            </p>
      ...
      <section className="container-px bg-porcelain py-20">
        <SectionHeader eyebrow="Наша команда" title="Люди, которые сопровождают ваш путь в FIA" text="Мы работаем рядом со студентами: помогаем познакомиться с академией, выбрать программу, разобраться в формате обучения и сделать следующий шаг к профессиональной практике." />
